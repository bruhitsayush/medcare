        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600">
              Have questions about our medical supplies? Our team is here to help you find the right solutions.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 text-lg mb-8">
                  Reach out to us through any of the following channels. Our customer service team is ready to assist you.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">{siteContent.company.phone}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">{siteContent.company.address}</p>
                  </div>
                </div>
              </div>
